...
export declare function panelTransport(panel: EspHomePanel): TransportKind;
/**
 ...
 */
export declare function createEspHomeClient(panel: EspHomePanel, log: Logger, label: string): Promise<IEspHomeClient>;
//# sourceMappingURL=esphomeTransport.d.ts.map